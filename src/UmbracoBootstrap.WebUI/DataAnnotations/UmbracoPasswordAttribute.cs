...
namespace Umbraco.Web.DataAnnotations
{
    ...
    public class UmbracoPasswordAttribute : MembershipPasswordAttribute, IClientValidatable
    {
        ...
        public UmbracoPasswordAttribute()
            : base()
        {
            ErrorMessage = UmbracoDictionary.Value("PasswordError");
            MinPasswordLengthError = UmbracoDictionary.Value("MinPasswordLengthError");
            MinNonAlphanumericCharactersError = UmbracoDictionary.Value("MinNonAlphanumericCharactersError");
            PasswordStrengthError = UmbracoDictionary.Value("PasswordStrengthError");
        }
